...
#define MAX_SPOT_LIGHT_COUNT 256
    ...
    namespace Shaders
    {
        ...
        static const uint s_PoissonSampleCount                     = 64u;
        static const float2 s_PoissonSamples[s_PoissonSampleCount] = {
        ...
        float2 GetPoissonSample(const uint idx)
        {
            return s_PoissonSamples[idx % s_PoissonSampleCount];
        }
